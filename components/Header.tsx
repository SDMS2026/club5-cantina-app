    ...
    <header className="sticky top-0 z-40 w-full border-b border-gray-200/80 bg-white/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-3 py-2 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col min-w-0">
              <div className="flex items-center gap-1 sm:gap-1.5">
                <span className="font-[family-name:var(--font-brand)] text-base sm:text-xl font-black tracking-tight inline-flex items-center gap-0.5 sm:gap-1 select-none">
                  <span className="text-[#0E52A0] drop-shadow-[0_1.5px_0_#FACC15]">
                    Club
                  </span>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          <div className="hidden sm:flex items-center gap-2.5 rounded-2xl border border-amber-200/80 bg-gradient-to-r from-amber-50/80 via-orange-50/50 to-yellow-50/70 px-3.5 py-1.5 shadow-2xs transition hover:border-amber-300">
            <div className="flex h-7 w-7 items-center justify-center rounded-xl bg-amber-500/15 text-amber-700 shrink-0">
            ...
            <div className="flex flex-col">
              ...
              <span
                className="font-mono text-xs sm:text-sm font-bold text-gray-900 whitespace-nowrap"
            ...
            <button
              ...
              className="ml-1 rounded-lg p-1 text-amber-800/70 hover:bg-amber-100/60 hover:text-amber-900 transition disabled:opacity-40"
            >
              <RefreshCw
          ...
          <div className="hidden md:flex items-center gap-1.5 rounded-xl border border-gray-200/80 bg-gray-50/80 px-2.5 py-1 text-xs text-gray-600">
