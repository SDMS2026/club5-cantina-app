...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center p-4 sm:p-6 overflow-hidden bg-[#F8FAFC]">
      {/* Elementos decorativos de fondo sutiles */}
      <div
        className="absolute top-[-10%] left-[-10%] w-96 h-96 rounded-full bg-blue-300/25 blur-3xl pointer-events-none"
        aria-hidden="true"
      />
      <div
        className="absolute bottom-[-10%] right-[-10%] w-96 h-96 rounded-full bg-amber-300/20 blur-3xl pointer-events-none"
        aria-hidden="true"
      />
      ...
      >
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-3xl border border-gray-100 shadow-xl shadow-gray-200/60 p-6 sm:p-8">
          {/* Cabecera / Branding Club 5 */}
          <div className="flex flex-col items-center text-center mb-7">
            <div className="relative mb-3 flex items-center justify-center">
              <div className="h-16 w-16 relative flex items-center justify-center rounded-2xl bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200/80 shadow-xs">
                <Image
            ...
            <div className="flex items-center justify-center mb-1">
              <span className="font-[family-name:var(--font-brand)] text-3xl font-black tracking-tight inline-flex items-center gap-1 select-none">
                <span className="text-[#0E52A0] drop-shadow-[0_2px_0_#FACC15]">Club</span>
            ...
            <p className="font-[family-name:var(--font-brand)] text-xs font-bold tracking-wide text-amber-700/90 mb-2">
              Cantina Escolar
            </p>

            <h1 className="text-lg font-bold text-gray-900 mt-2">Iniciar Sesión</h1>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  disabled={cargando}
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50/50 text-sm text-gray-900 placeholder:text-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0E52A0]/25 focus:border-[#0E52A0] transition disabled:opacity-60"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  disabled={cargando}
                  className="w-full pl-10 pr-10 py-2.5 rounded-xl border border-gray-200 bg-gray-50/50 text-sm text-gray-900 placeholder:text-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0E52A0]/25 focus:border-[#0E52A0] transition disabled:opacity-60"
                />
                <button
                  type="button"
                  onClick={() => setMostrarPassword(!mostrarPassword)}
                  disabled={cargando}
                  className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-gray-400 hover:text-gray-600 transition disabled:opacity-50"
