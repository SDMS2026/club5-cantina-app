...
type MetodoCancelacionId = 'pago_movil' | 'efectivo_usd' | 'zelle' | 'punto_debito';
...
export default function DeudasPage() {
  ...
  const cargarDeudas = useCallback(async () => {
    ...
    try {
      ...
      console.error('Excepción cargando consumos pendientes:', e);
    } finally {
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <span className="rounded-full border border-amber-200 bg-amber-50 px-1.5 py-0.2 text-[10px] sm:text-[11px] font-semibold text-amber-800 shrink-0">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <div className="flex flex-col sm:items-end gap-3 border-t sm:border-t-0 pt-3 sm:pt-0 border-gray-100">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {/* Botón Abonar / Cancelar Cuenta Total */}
                          <button
                            type="button"
                            ...
                            >
                              ...
                              <div className="flex items-center justify-between sm:justify-end gap-3 pt-2 sm:pt-0 border-t sm:border-t-0 border-gray-200/50">
                                ...
                                <button
                                  type="button"
                                  onClick={() =>
                                    handleAbrirPagoConsumoIndividual(consumo, estudiante)
                                  }
